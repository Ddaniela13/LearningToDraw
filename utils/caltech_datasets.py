...
class Caltech101(VisionDataset):
    ...
    def download(self) -> None:
        ...
        download_and_extract_archive(
            "http://marc.ecs.soton.ac.uk/~jsh2/datasets/Caltech101/101_ObjectCategories.tar.gz",
            self.root,
            filename="101_ObjectCategories.tar.gz",
            md5="b224c7392d521a49829488ab0f1120d9")
        download_and_extract_archive(
            "http://marc.ecs.soton.ac.uk/~jsh2/datasets/Caltech101/Annotations.tar",
            self.root,
...
class Caltech256(VisionDataset):
    ...
    def download(self) -> None:
        ...
        download_and_extract_archive(
            "http://marc.ecs.soton.ac.uk/~jsh2/datasets/Caltech256/256_ObjectCategories.tar",
            self.root,
